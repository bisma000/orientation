...
public class ResponsableInterface {
    ...
    private void showVoeuxStatistics() {
        ...
        Map<Integer, Integer> prioriteAcceptedCount = GestionnaireJSON.compterVoeuxAcceptesParPriorite();
        ...
        int totalStudents = GestionnaireJSON.getTotalStudents("src/etudiants.json");
        int premierChoixAcceptedCount = prioriteAcceptedCount.getOrDefault(1, 0);
        int deuxiemeChoixAcceptedCount = prioriteAcceptedCount.getOrDefault(2, 0);
        int troisiemeChoixAcceptedCount = prioriteAcceptedCount.getOrDefault(3, 0);

        double premierChoixPourcentage = (double) premierChoixAcceptedCount / totalStudents * 100;
        double deuxiemeChoixPourcentage = (double) deuxiemeChoixAcceptedCount / totalStudents * 100;
        double troisiemeChoixPourcentage = (double) troisiemeChoixAcceptedCount / totalStudents * 100;
